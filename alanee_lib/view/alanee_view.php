...
class renderView {
	...
	public function render() {
		$this->css = $this->rootPath.'css/';
		$this->javascript = $this->rootPath.'js/';
		$this->images = $this->rootPath.'images/';
